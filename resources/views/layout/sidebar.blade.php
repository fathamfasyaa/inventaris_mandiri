    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">Inventary MU</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseBarang" class="collapse" aria-labelledby="headingBarang"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('barang_inventaris.index') }}">Daftar Barang</a>
                        <a class="collapse-item" href="{{ route('barang_inventaris.create') }}">Penerimaan Barang</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePeminjaman" class="collapse" aria-labelledby="headingPeminjaman"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('pengembalian.index') }}">Pengembalian Barang</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span {{-- nama akun --}} class="mr-2 d-none d-lg-inline text-gray-700 small">
                                </span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; fathan</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
